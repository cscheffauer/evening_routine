    ...
    motivationQuotes: [
        {
            ...
            imageUrl: 'images/quotes/1_act as if.jpg'
        },
        {
            quote: 'Success is not final, failure is not fatal: it is the courage to continue that counts.',
            author: 'Winston Churchill',
            imageUrl: 'images/quotes/2_success.jpg'
        },
        {
            quote: 'Never bend your head. Always hold it high. Look the world straight in the eye.',
            author: 'Helen Keller',
            imageUrl: 'images/quotes/3_eye.jpg'
        },
        {
            quote: 'What you get by achieving your goals is not as important as what you become by achieving your goals.',
            author: 'Zig Ziglar',
            imageUrl: 'images/quotes/4_achieve_goals.jpg'
        },
        {
            quote: "Believe you can and you're halfway there.",
            author: 'Theodore Roosevelt',
            imageUrl: 'images/quotes/5_believe.jpg'
        },
        {
            quote: "When you have a dream, you've got to grab it and never let go.",
            author: 'Carol Burnett',
            imageUrl: 'images/quotes/6_dream.jpg'
        },
        {
            quote: "I can't change the direction of the wind, but I can adjust my sails to always reach my destination.",
            author: 'Jimmy Dean',
            imageUrl: 'images/quotes/7_sail.jpg'
        },
        {
            quote: "No matter what you're going through, there's a light at the end of the tunnel.",
            author: 'Demi Lovato',
            imageUrl: 'images/quotes/8_tunnel.jpg'
        },
        {
            ...
            author: 'William James',
            imageUrl: 'images/quotes/9_attitude.jpg'
        },
        {
            quote: "Life is like riding a bicycle. To keep your balance, you must keep moving.",
            author: 'Albert Einstein',
            imageUrl: 'images/quotes/10_bicycle.jpg'
        },
        {
        ...
        },
        {
            ...
            author: 'Mae Jemison',
            imageUrl: 'images/quotes/31_imagination.jpg'
        },
        {
            quote: "Be the change that you wish to see in the world.",
            author: 'Mahatma Gandhi',
            imageUrl: 'images/quotes/32_gandhi.jpg'
        },
        {
            quote: "We can be heroes just for one day.",
            author: 'David Bowie',
            imageUrl: 'images/quotes/33_heroes_bowie.jpg'
        },
    ]
};