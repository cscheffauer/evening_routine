...
import { changeRoute, changeDarkMode, changeGoals, changeRoutine } from './reducers/reducers';

import Theme from './components/Theme/Theme';

const logger = createLogger();
const rootReducer = combineReducers({ changeRoute, changeDarkMode, changeGoals, changeRoutine });       //combine the reducers from the reducers file into one root reducer
